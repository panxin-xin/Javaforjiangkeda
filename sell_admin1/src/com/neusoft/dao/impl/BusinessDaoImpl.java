...
public abstract class BusinessDaoImpl  implements BusinessDao {
...
//        System.out.println("sql ="+sql.toString());
    ...
    public abstract int supdateBusiness(Business business);

    public abstract Business getBusinessById();
}